...
from dataloader_3 import DTX_clinic_Dataset, DTXDataset
...
valid_data = DTX_clinic_Dataset(args.valid_csv,args.valid_data_path,max_len = args.max_len)
...
dataloaders = { 'train' : DataLoader(image_datasets["train"], batch_size=6,
                ...
                'val' : DataLoader(image_datasets['val'], batch_size=6,
                                    num_workers=2) }
